...
# Vamos falar nesse módulo de algumas outras, mas esse conceito é importante porque várias funções do python usam isso
# para explicar como as coisas funcionam. Então é importante que quando você ler o termo "iterable" você entenda o que
# estão falando: "é tipo uma lista de coisas que eu posso percorrer e fazer alguma ação com cada uma das coisas dentro dessa lista"