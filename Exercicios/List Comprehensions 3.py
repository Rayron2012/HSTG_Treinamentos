...
'''Utilizndo if antes do for, ele define os valores que vão entrar para a condição (Como se fosse uma decisão), 
já depois do for ele utiliza como filtros'''
...
lista_pedido2 = [1000 if qtd < 200 else 500 for produto2, qtd in estoque]
